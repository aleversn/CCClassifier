...
trainer = Trainer(tokenizer, model_dir='model/chinese_wwm_ext', dataset_name='sccls', padding_length=400, num_labels=14, batch_size=64, batch_size_eval=1000)
...
# %%
tokenizer = BertTokenizer.from_pretrained('model/chinese_wwm_ext')
pred = Predictor(tokenizer, model_dir='model/chinese_wwm_ext', padding_length=400, resume_path='./model/cls/bert/epoch_1.pth', num_labels=14, gpu=[0, 1, 2, 3])
